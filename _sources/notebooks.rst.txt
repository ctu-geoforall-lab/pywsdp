...
Dešifrovaná data můžeme uložit i do CSV nebo JSON souboru, jako je ukázáno v druhém sešitu.
...
Sestavy
#######################
Pro sestavy máme připravenou ukázku použití modulu GenerujCenoveUdajeDleKu s využitím veřejného API sestav,
...
Dále umožňuje dešifrovat soubor sestavy formátu ZIP a uložit ho do námi zvoleného adresáře.
